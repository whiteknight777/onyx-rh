    ...
    return (
        <>
            ...
            <form className="form">
                ...
                <div className="row">
                    <div className="col-xl-12 px-10 pr-15">
                        <h3 className="font-size-h6 mb-5">2. Sécurité</h3>
                    </div>
                </div>
                <div className="row">
                    <div className="col-xl-12 px-10 pr-15">
                        <div className="form-group row">
                            <span className="col-xl-3 col-lg-3 col-form-label text-left">Vérification à la connexion</span>
                            <div className="col-lg-9">
                                <div className="checkbox-inline">
                        ...
                        <div className="form-group row">
                            <span className="col-xl-3 col-lg-3 col-form-label text-left">Verification après restauration du mdp</span>
                            <div className="col-lg-9">
                                <div className="checkbox-inline">
